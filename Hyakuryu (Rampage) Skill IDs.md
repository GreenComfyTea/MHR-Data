...
`HyakuryuSkill_002`  |   3 | `Attack Boost III`
`HyakuryuSkill_003`  |   4 | `Attack Boost IV`
`HyakuryuSkill_004`  |   5 | `Attack Surge`
`HyakuryuSkill_005`  |   6 | `Elemental Boost I`
`HyakuryuSkill_006`  |   7 | `Elemental Boost II`
`HyakuryuSkill_007`  |   8 | `Elemental Boost III`
`HyakuryuSkill_008`  |   9 | `Elemental Surge`
`HyakuryuSkill_009`  |  10 | `Affinity Boost I`
`HyakuryuSkill_010`  |  11 | `Affinity Boost II`
`HyakuryuSkill_011`  |  12 | `Affinity Boost III`
`HyakuryuSkill_012`  |  13 | `Affinity Boost IV`
`HyakuryuSkill_013`  |  14 | `Affinity Surge`
`HyakuryuSkill_014`  |  15 | `Defense Boost I`
`HyakuryuSkill_015`  |  16 | `Defense Boost II`
`HyakuryuSkill_016`  |  17 | `Defense Boost III`
`HyakuryuSkill_017`  |  18 | `Fire Boost I`
`HyakuryuSkill_018`  |  19 | `Fire Boost II`
`HyakuryuSkill_019`  |  20 | `Fire Boost III`
`HyakuryuSkill_020`  |  21 | `Fire Boost IV`
`HyakuryuSkill_021`  |  22 | `Water Boost I`
`HyakuryuSkill_022`  |  23 | `Water Boost II`
`HyakuryuSkill_023`  |  24 | `Water Boost III`
`HyakuryuSkill_024`  |  25 | `Water Boost IV`
`HyakuryuSkill_025`  |  26 | `Thunder Boost I`
`HyakuryuSkill_026`  |  27 | `Thunder Boost II`
`HyakuryuSkill_027`  |  28 | `Thunder Boost III`
`HyakuryuSkill_028`  |  29 | `Thunder Boost IV`
`HyakuryuSkill_029`  |  30 | `Ice Boost I`
`HyakuryuSkill_030`  |  31 | `Ice Boost II`
`HyakuryuSkill_031`  |  32 | `Ice Boost III`
`HyakuryuSkill_032`  |  33 | `Ice Boost IV`
`HyakuryuSkill_033`  |  34 | `Dragon Boost I`
`HyakuryuSkill_034`  |  35 | `Dragon Boost II`
`HyakuryuSkill_035`  |  36 | `Dragon Boost III`
`HyakuryuSkill_036`  |  37 | `Dragon Boost IV`
`HyakuryuSkill_037`  |  38 | `Poison Boost I`
`HyakuryuSkill_038`  |  39 | `Poison Boost II`
`HyakuryuSkill_039`  |  40 | `Poison Boost III`
`HyakuryuSkill_040`  |  41 | `Paralysis Boost I`
`HyakuryuSkill_041`  |  42 | `Paralysis Boost II`
`HyakuryuSkill_042`  |  43 | `Paralysis Boost III`
`HyakuryuSkill_043`  |  44 | `Sleep Boost I`
`HyakuryuSkill_044`  |  45 | `Sleep Boost II`
`HyakuryuSkill_045`  |  46 | `Sleep Boost III`
`HyakuryuSkill_046`  |  47 | `Blast Boost I`
`HyakuryuSkill_047`  |  48 | `Blast Boost II`
`HyakuryuSkill_048`  |  49 | `Blast Boost III`
`HyakuryuSkill_049`  |  50 | `Fire I`
`HyakuryuSkill_050`  |  51 | `Fire II`
`HyakuryuSkill_051`  |  52 | `Fire III`
`HyakuryuSkill_052`  |  53 | `Fire IV`
`HyakuryuSkill_053`  |  54 | `Water I`
`HyakuryuSkill_054`  |  55 | `Water II`
`HyakuryuSkill_055`  |  56 | `Water III`
`HyakuryuSkill_056`  |  57 | `Water IV`
`HyakuryuSkill_057`  |  58 | `Thunder I`
`HyakuryuSkill_058`  |  59 | `Thunder II`
`HyakuryuSkill_059`  |  60 | `Thunder III`
`HyakuryuSkill_060`  |  61 | `Thunder IV`
`HyakuryuSkill_061`  |  62 | `Ice I`
...
`HyakuryuSkill_125`  | 126 | `Phial: Paralysis II`
...
`HyakuryuSkill_189`  | 190 | `Special: Wyvernsnipe`
...
`HyakuryuSkill_253`  | 254 | `Narwa Soul`
