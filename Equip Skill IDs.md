...
`Pl_EquipSkill_002`  |   3 | `Peak Performance`
`Pl_EquipSkill_003`  |   4 | `Resentment`
`Pl_EquipSkill_004`  |   5 | `Resuscitate`
`Pl_EquipSkill_005`  |   6 | `Critical Eye`
`Pl_EquipSkill_006`  |   7 | `Critical Boost`
`Pl_EquipSkill_007`  |   8 | `Weakness Exploit`
`Pl_EquipSkill_008`  |   9 | `Latent Power`
`Pl_EquipSkill_009`  |  10 | `Maximum Might`
`Pl_EquipSkill_010`  |  11 | `Critical Element`
`Pl_EquipSkill_011`  |  12 | `Master's Touch`
`Pl_EquipSkill_012`  |  13 | `Fire Attack`
`Pl_EquipSkill_013`  |  14 | `Water Attack`
`Pl_EquipSkill_014`  |  15 | `Ice Attack`
`Pl_EquipSkill_015`  |  16 | `Thunder Attack`
`Pl_EquipSkill_016`  |  17 | `Dragon Attack`
`Pl_EquipSkill_017`  |  18 | `Poison Attack`
`Pl_EquipSkill_018`  |  19 | `Paralysis Attack`
`Pl_EquipSkill_019`  |  20 | `Sleep Attack`
`Pl_EquipSkill_020`  |  21 | `Blast Attack`
`Pl_EquipSkill_021`  |  22 | `Handicraft`
`Pl_EquipSkill_022`  |  23 | `Razor Sharp`
`Pl_EquipSkill_023`  |  24 | `Spare Shot`
`Pl_EquipSkill_024`  |  25 | `Protective Polish`
`Pl_EquipSkill_025`  |  26 | `Mind's Eye`
`Pl_EquipSkill_026`  |  27 | `Ballistics`
`Pl_EquipSkill_027`  |  28 | `Bludgeoner`
`Pl_EquipSkill_028`  |  29 | `Bow Charge Plus`
`Pl_EquipSkill_029`  |  30 | `Focus`
`Pl_EquipSkill_030`  |  31 | `Power Prolonger`
`Pl_EquipSkill_031`  |  32 | `Marathon Runner`
`Pl_EquipSkill_032`  |  33 | `Constitution`
`Pl_EquipSkill_033`  |  34 | `Stamina Surge`
`Pl_EquipSkill_034`  |  35 | `Guard`
`Pl_EquipSkill_035`  |  36 | `Guard Up`
`Pl_EquipSkill_036`  |  37 | `Offensive Guard`
`Pl_EquipSkill_037`  |  38 | `Critical Draw`
`Pl_EquipSkill_038`  |  39 | `Punishing Draw`
`Pl_EquipSkill_039`  |  40 | `Quick Sheathe`
`Pl_EquipSkill_040`  |  41 | `Slugger`
`Pl_EquipSkill_041`  |  42 | `Stamina Thief`
`Pl_EquipSkill_042`  |  43 | `Affinity Sliding`
`Pl_EquipSkill_043`  |  44 | `Horn Maestro`
`Pl_EquipSkill_044`  |  45 | `Artillery`
`Pl_EquipSkill_045`  |  46 | `Load Shells`
`Pl_EquipSkill_046`  |  47 | `Special Ammo Boost`
`Pl_EquipSkill_047`  |  48 | `Normal/Rapid Up`
`Pl_EquipSkill_048`  |  49 | `Pierce Up`
`Pl_EquipSkill_049`  |  50 | `Spread Up`
`Pl_EquipSkill_050`  |  51 | `Ammo Up`
`Pl_EquipSkill_051`  |  52 | `Reload Speed`
`Pl_EquipSkill_052`  |  53 | `Recoil Down`
`Pl_EquipSkill_053`  |  54 | `Steadiness`
`Pl_EquipSkill_054`  |  55 | `Rapid Fire Up`
`Pl_EquipSkill_055`  |  56 | `Defense Boost`
`Pl_EquipSkill_056`  |  57 | `Divine Blessing`
`Pl_EquipSkill_057`  |  58 | `Recovery Up`
`Pl_EquipSkill_058`  |  59 | `Recovery Speed`
`Pl_EquipSkill_059`  |  60 | `Speed Eating`
`Pl_EquipSkill_060`  |  61 | `Earplugs`
`Pl_EquipSkill_061`  |  62 | `Windproof`
